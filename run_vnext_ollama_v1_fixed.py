...
def main():
    ...
    # diagnostic tracking for final record
    last_pi_raw = None
    last_pi_norm = None
    last_rep_score = None
    last_pi_flag = None
    ...
    try:
        ...
        for seg in range(max_segments):
            ...
            # track for final record
            last_pi_raw = float(pi_raw)
            last_pi_norm = float(pi_n)
            last_rep_score = float(rep)
            last_pi_flag = int(pi_flag)
            last_rep_flag = int(rep_flag)
        ...
        final = {
            ...
            # diagnostic fields (fixes NaN in runs_summary_all.csv)
            "pi_raw_last": last_pi_raw,
            "pi_norm_last": last_pi_norm,
            "rep_score_last": last_rep_score,
            "pi_flag_any": last_pi_flag,
            "rep_flag_any": last_rep_flag,
        }
